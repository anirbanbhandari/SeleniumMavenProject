...
public class Program1 {
	...
	public static void main(String[] args) {
		...
		test = report.startTest("LogIn-1", "Verify that User is able to Login with valid data");
		...
		test = report.startTest("LogIn-2", "Verify that User is unable to Login with invalid data");
