...
public class Framework {
	...
	public static void typeIn(String fieldName) throws Exception {
		...
		test.log(LogStatus.INFO, "User enters value in " + fieldName + " as " + getData(fieldName));
	}
	...
	public static void dropDownByIndex(String fieldName) throws Exception {
	...
	public static void dropDownByValue(String fieldName) throws Exception {
		Select dropDown = new Select(driver.findElement(By.xpath(getXpath(fieldName))));
		dropDown.selectByValue(getData(fieldName));
		test.log(LogStatus.INFO, "User selected dropdown in" + fieldName + " as " + getData(fieldName));
	}

	public static void dropDownByText(String fieldName) throws Exception {
		Select dropDown = new Select(driver.findElement(By.xpath(getXpath(fieldName))));
